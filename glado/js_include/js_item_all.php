...
<?php 
	...
	?>
	  <div id="content"> 
		...
		<br>
		  <h1><?php echo $database->js_num_rows( $js_db_query ) ?> Bridal Gowns
		  <a style="float:right;width:300px;text-align:center;" href="index.php?action=item_new">New Bridal Gown</a> </h1> 
          <br><hr><br>

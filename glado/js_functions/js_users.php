<?php
	function js_signin() {
		...
		$loginkey = md5($_POST['password']);
			...
			$_SESSION['glado_user'] = js_let_me_user($loginname, $loginkey);
			$_SESSION['glado_account'] = js_logged_account($loginname);
	...
	function js_is_logged(){
		$myloginid = isset( $_SESSION['glado_user'] ) ? $_SESSION['glado_user'] : "";
...
function logout() {
  unset( $_SESSION['glado_user'] );
  unset( $_SESSION['glado_account'] );
  header( "Location: index.php" );
}
